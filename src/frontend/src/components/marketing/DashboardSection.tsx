            ...
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="font-cyber font-bold text-lg text-center leading-tight">
                    {tab.label}
                  </p>
                </button>
              );
          ...
          {activeTab === 'panels' && (
            <div className="glass-panel p-10 md:p-12 rounded-3xl card-elevated border-2 border-primary/40">
              ...
              <button
                ...
                className="w-full md:w-auto py-5 px-10 glass-panel-alt rounded-xl font-cyber font-bold text-xl tracking-wide hover-glow-blue transition-all duration-300 flex items-center justify-center gap-4 group border-2 border-primary/40"
              >
          ...
          {activeTab === 'profile' && (
            <div className="glass-panel p-10 md:p-12 rounded-3xl card-elevated border-2 border-primary/40">
              ...
              <div className="glass-panel-alt p-7 rounded-xl border-2 border-accent/40">
                <p className="text-lg text-center font-cyber font-semibold leading-relaxed">
            ...
            <div className="glass-panel p-10 md:p-12 rounded-3xl card-elevated border-2 border-primary/40">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="font-cyber font-bold text-xl text-center leading-tight">
                    WhatsApp Support
                  </p>
                  <p className="text-base text-accent font-cyber font-semibold">
                    {WHATSAPP_NUMBER}
                  </p>
                </a>
                <a
            ...
            <div className="glass-panel p-10 md:p-12 rounded-3xl card-elevated border-2 border-primary/40">
              ...
              <div className="space-y-5">
                <div className="glass-panel-alt p-6 rounded-xl border-2 border-primary/40 flex items-center justify-between">
                  <span className="font-cyber font-bold text-xl">Panel Delivery</span>
                ...
                <div className="glass-panel-alt p-6 rounded-xl border-2 border-primary/40 flex items-center justify-between">
                  <span className="font-cyber font-bold text-xl">Payment Gateway</span>
                  <span className="px-5 py-2 bg-green-500/20 text-green-400 rounded-lg font-cyber font-bold text-base border border-green-500/40">
                    Operational
                  </span>
                </div>
                <div className="glass-panel-alt p-6 rounded-xl border-2 border-primary/40 flex items-center justify-between">
                  <span className="font-cyber font-bold text-xl">Support Services</span>
                  <span className="px-5 py-2 bg-green-500/20 text-green-400 rounded-lg font-cyber font-bold text-base border border-green-500/40">
                    Operational
                  </span>
                </div>
